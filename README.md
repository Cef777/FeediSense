...
| --- | --- |
| <img src="https://via.placeholder.com/250x500.png?text=App+Screenshot" width="250" alt="App UI"/> | <img src="https://via.placeholder.com/350x500.png?text=Arduino+Prototype" width="350" alt="Hardware Setup"/> |
